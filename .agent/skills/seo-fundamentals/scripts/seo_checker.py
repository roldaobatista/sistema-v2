...
# Directories to skip
SKIP_DIRS = {
    'node_modules', 'vendor', '.next', 'dist', 'build', '.git', '.github',
    '__pycache__', '.vscode', '.idea', 'coverage', 'test', 'tests',
    '__tests__', 'spec', 'docs', 'documentation', 'examples',
    'testsprite_tests', '.agent', 'reports', 'storage', 'public/icons', 'public/assets',
    '.worktrees', '.superpowers', '.codex', '.cursor', '.zap', 'playwright-report', 'e2e'
}
