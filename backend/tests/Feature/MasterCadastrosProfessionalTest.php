...
/**
 * Professional Master Cadastros tests — exact status assertions, DB verification.
 */
class MasterCadastrosProfessionalTest extends TestCase
{
    ...
    public function test_standard_weights_constants_returns_enums(): void
    {
        $response = $this->getJson('/api/v1/standard-weights/constants');
        $response->assertOk()
            ->assertJsonStructure(['data' => ['precision_classes', 'units', 'statuses']]);
    }
