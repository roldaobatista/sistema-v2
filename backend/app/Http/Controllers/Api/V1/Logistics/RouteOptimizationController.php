...
use App\Http\Requests\Logistics\OptimizeLogisticsRouteRequest;
...
class RouteOptimizationController extends Controller
{
    ...
    public function optimize(OptimizeLogisticsRouteRequest $request): JsonResponse
    {
