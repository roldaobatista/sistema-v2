...
class StoreStandardWeightRequest extends FormRequest
{
    public function authorize(): bool
    {
        return $this->user()->can('equipments.standard_weight.create');
    }
    ...
    public function rules(): array
    {
        return [
            ...
            'serial_number' => [
                ...
                Rule::unique('standard_weights')->where('tenant_id', $this->tenantId()),
            ],
    ...
    {
        return [
            'nominal_value.required' => 'O valor nominal e obrigatório.',
