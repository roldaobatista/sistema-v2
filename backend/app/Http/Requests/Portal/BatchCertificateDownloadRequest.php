...
class BatchCertificateDownloadRequest extends FormRequest
{
    public function authorize(): bool
    {
        return $this->user()->can('portal.certificate.view');
    }
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'certificate_ids.*' => Rule::exists('calibration_certificates', 'id')->where(fn ($q) => $q->where('tenant_id', $tenantId)),
