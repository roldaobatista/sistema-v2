...
class StoreToolCalibrationRequest extends FormRequest
{
    ...
    {
        return $this->user()->can('calibration.tool.create');
    }
    ...
    protected function prepareForValidation(): void
    {
        ...
        foreach (['next_due_date', 'next_calibration_date', 'certificate_number', 'laboratory', 'performed_by', 'result', 'status', 'notes'] as $field) {
    ...
    public function rules(): array
    {
        ...
        return [
            'tool_inventory_id' => ['required', Rule::exists('tool_inventories', 'id')->where('tenant_id', $tenantId)],
