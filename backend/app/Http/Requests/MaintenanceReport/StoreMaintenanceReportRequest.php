...
class StoreMaintenanceReportRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'defect_found' => ['required', 'string', 'max:5000'],
            ...
            'condition_before' => ['required', 'string', 'in:defective,degraded,functional,unknown'],
            'condition_after' => ['required', 'string', 'in:functional,limited,requires_calibration,not_repaired'],
