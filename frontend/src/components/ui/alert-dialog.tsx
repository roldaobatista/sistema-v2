  ...
  <AlertDialogPortal>
    ...
    <AlertDialogPrimitive.Content
      ...
      className={cn(
        ...
        "gap-4 rounded-xl border border-default bg-surface-0 p-6 shadow-modal",
...
>(({ className, ...props }, ref) => (
  <AlertDialogPrimitive.Description
    ref={ref}
    className={cn("text-[13px] text-surface-500 leading-relaxed", className)}
    {...props}
  />
))
...
>(({ className, ...props }, ref) => (
  <AlertDialogPrimitive.Action
    ref={ref}
    className={cn(
      "inline-flex h-8 items-center justify-center gap-2 rounded-md px-3.5 text-[13px] font-medium transition-colors duration-150",
