    ...
    for (const f of fs.readdirSync(dir, { withFileTypes: true })) {
        ...
        if (f.isDirectory()) walk(fp);
            ...
            switch (pageType) {
                ...
                case 'form': weights.hasPagination = 0; weights.hasSearch = 0; weights.hasDeleteConfirm = 0; weights.hasEmptyState = 0; break;
                ...
                case 'utility': weights.hasPagination = 0; weights.hasDeleteConfirm = 0; weights.hasEmptyState = 0; break;
                case 'tabbed': weights.hasPagination = 0; weights.hasForm = 0; weights.hasEmptyState = 0; weights.hasDeleteConfirm = 0; break;
